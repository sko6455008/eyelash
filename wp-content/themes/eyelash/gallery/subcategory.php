<?php
/**
 * ギャラリーサブカテゴリーアーカイブページ
 * URL: /gallery/{main-category-slug}/{sub-category-slug}/
 *
 * @package Eyelash
 */
...
// カテゴリー名を取得
$main_category_name = $main_category ? $main_category->name : '';
$sub_category_name = $sub_category ? $sub_category->name : '';

// ペジネーション
$paged = get_query_var('paged') ? get_query_var('paged') : 1;

// このサブカテゴリーのギャラリー投稿を取得
...
<main class="l-main">
    <ul class="p-breadcrumb c-breadcrumb" itemscope="" itemtype="https://schema.org/BreadcrumbList">
        ...
        <li class="p-breadcrumb__item c-breadcrumb__item" itemprop="itemListElement" itemscope=""
            ...
            <a href="<?php echo esc_url(home_url('/gallery/' . $main_cat_slug . '/')); ?>" itemscope=""
                ...
                <span itemprop="name"><?php echo esc_html($main_category_name); ?></span>
            </a>
            <meta itemprop="position" content="3">
        </li>
        <li class="p-breadcrumb__item c-breadcrumb__item"><?php echo esc_html($sub_category_name); ?></li>
    </ul>
    <header class="p-page-header" style="background: #b7aa9d;">
        <div class="p-page-header__inner l-inner">
            ...
            <p class="p-page-header__desc" style="color: ;">なりたいイメージを形にする、豊富なデザインバリエーション。</p>
        </div>
    </header>
    ...
    <div class="l-main__inner l-inner">
        <ul class="p-breadcrumb c-breadcrumb" itemscope="" itemtype="https://schema.org/BreadcrumbList">
            ...
            <li class="p-breadcrumb__item c-breadcrumb__item">
                <?php echo esc_html($main_category_name); ?>
            </li>
            <li class="p-breadcrumb__item c-breadcrumb__item">
        ...
        <div class="l-contents--gallery">
            ...
            <!-- サイドバー -->
            <?php
            // 現在のメインカテゴリーとサブカテゴリーをサイドバーに渡す
            set_query_var('current_main_category', $main_cat_slug);
            set_query_var('current_sub_category', $sub_cat_slug);
            get_sidebar('gallery');
            ?>
        </div>
    </div>
