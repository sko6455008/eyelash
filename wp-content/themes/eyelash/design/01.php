                ...
                <div class="tcd-pb-row-inner clearfix">
                  <div class="tcd-pb-col col1">
                    ...
                    <div class="tcd-pb-widget widget2 pb-widget-editor">
                      ...
                      <p class="mb0">
                        <img src="<?php echo esc_url($theme_uri); ?>/design/page-lseries02.jpg">
                        <img src="<?php echo esc_url($theme_uri); ?>/design/page-lseries03.jpg">
                        <img src="<?php echo esc_url($theme_uri); ?>/design/page-lseries04.jpg">
                      </p>
                      </p>
                    </div>
                  </div>
