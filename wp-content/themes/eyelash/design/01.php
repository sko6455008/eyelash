                ...
                <div class="tcd-pb-row-inner clearfix">
                  <div class="tcd-pb-col col1">
                    ...
                    <div class="tcd-pb-widget widget2 pb-widget-editor">
                      <h4>ビューラーで立ち上げた時のように、まつ毛の存在感が出てパッチリとしたお目元を演出できるカール。</h4>
                      <p>
                        根元がまっすぐなので、グルーと地まつ毛の接着面積が増え、まぶたの重みにも耐えることができるので、キレイなカールを維持することができます。<BR>他のカールと比較すると、接着面にあたる根元のストレート部分は約１mm。Lシリーズは約３倍の３mmになります!!
                      ...
                      <p class="mb0">
                        <img src="<?php echo esc_url($theme_uri); ?>/design/page-lseries02.jpg" alt="Lカールおすすめポイント1">
                        <img src="<?php echo esc_url($theme_uri); ?>/design/page-lseries03.jpg" alt="Lカールおすすめポイント2">
                        <img src="<?php echo esc_url($theme_uri); ?>/design/page-lseries04.jpg" alt="Lカールおすすめポイント3">
                      </p>
                      </p>
                    </div>
                  </div>
